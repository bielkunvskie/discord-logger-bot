...
// Função para obter a hora, minuto e segundo formatados
...
client.on('messageCreate', (message) => {
  if (!message.author.bot) {
    ...
    // Mensagem de depuração para verificar se o canal de logs foi encontrado
    console.log(`[${getCurrentTime()}] Canal de logs encontrado:`, logChannel ? 'Sim' : 'Não');

    if (logChannel) {
      logChannel.send(`[${getCurrentTime()}] [MSG] ${message.author.tag}: ${message.content}`);
    } else {
      console.log(`[${getCurrentTime()}] Não foi possível encontrar o canal de logs.`);
    }
  }
});
...
client.on('messageReactionAdd', (reaction, user) => {
  ...
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para reação:`, channel ? 'Sim' : 'Não');
...
client.on('messageReactionRemove', (reaction, user) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para remoção de reação:`, channel ? 'Sim' : 'Não');
...
client.on('messageUpdate', (oldMessage, newMessage) => {
  if (oldMessage.content !== newMessage.content) {
    ...
    // Mensagem de depuração
    console.log(`[${getCurrentTime()}] Canal de logs encontrado para edição de mensagem:`, channel ? 'Sim' : 'Não');
...
client.on('messageDelete', (message) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para exclusão de mensagem:`, channel ? 'Sim' : 'Não');
...
client.on('voiceStateUpdate', (oldState, newState) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para atualização de estado de voz:`, channel ? 'Sim' : 'Não');
...
client.on('channelCreate', (channel) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para criação de canal:`, logChannel ? 'Sim' : 'Não');
...
client.on('channelDelete', (channel) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para exclusão de canal:`, logChannel ? 'Sim' : 'Não');
...
client.on('guildMemberAdd', (member) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para entrada de membro:`, logChannel ? 'Sim' : 'Não');
...
client.on('guildMemberRemove', (member) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para saída de membro:`, logChannel ? 'Sim' : 'Não');
...
client.on('guildBanAdd', (guild, user) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para banimento de membro:`, logChannel ? 'Sim' : 'Não');
...
client.on('guildBanRemove', (guild, user) => {
  ...
  // Mensagem de depuração
  console.log(`[${getCurrentTime()}] Canal de logs encontrado para desbanimento de membro:`, logChannel ? 'Sim' : 'Não');
...
client.login(botToken).catch((error) => {
  console.error(`[${getCurrentTime()}] Erro ao tentar fazer login:`, error);
  process.exit(1);
});
